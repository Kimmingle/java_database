...
public class Datafile {
	...
	public String toString() {
		return "Controlfile [creation_time=" + creation_time + ", status=" + status + ", enabled=" + enabled
				+ ", bytes=" + bytes + ", blocks=" + blocks + ", create_bytes=" + create_bytes + ", block_size="
				+ block_size + ", name=" + name + ", con_id=" + con_id + "]";
	}
}
