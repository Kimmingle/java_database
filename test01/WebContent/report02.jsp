...
<%
	...
	try{
		...
		while(rs.next()){
			Controlfile Control = new Controlfile(rs.getString("name"),
		...
		while(rs.next()){
			Logfile log = new Logfile(rs.getString("type"),
							rs.getString("member"),
							rs.getString("is_recovery_dest_file"),
							rs.getInt("con_id;"));
...
<table style="width:1200px;margin:30px auto">
	<thead>
		<tr>
			<th>type</th><th>member</th><th>is_recovery_dest_file</th><th>con_id</th>
		</tr>
	</thead>
	<tbody>
